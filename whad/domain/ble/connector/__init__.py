...
from whad.metadata import generate_ble_metadata, BLEMetadata
...
from whad.domain.ble.connector.peripheral import Peripheral
from whad.domain.ble.connector.central import Central
