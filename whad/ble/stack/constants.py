...
class BtVersion(object):
    ...
    @property
    def value(self):
        """Convert major.minor version into corresponding number
        """
        if self.major == 4 and self.minor >= 0 and self.minor < 3:
            return 0x06 + self.minor
        if self.major == 5 and self.minor >=0 and self.minor < 4:
            return 0x09 + self.minor
...
BT_VERSIONS = {
    0x00: BtVersion(-1, -1, 'Reserved'),
    0x01: BtVersion(-1, -1, 'Reserved'),
    0x02: BtVersion(-1, -1, 'Reserved'),
    0x03: BtVersion(-1, -1, 'Reserved'),
    0x04: BtVersion(-1, -1, 'Reserved'),
    0x05: BtVersion(-1, -1, 'Reserved'),
    0x06: BtVersion(4, 0, 'Bluetooth® Core Specification 4.0'),
    0x07: BtVersion(4, 1, 'Bluetooth Core Specification 4.1'),
    0x08: BtVersion(4, 2, 'Bluetooth Core Specification 4.2'),
    0x09: BtVersion(5, 0, 'Bluetooth Core Specification 5.0'),
    0x0A: BtVersion(5, 1, 'Bluetooth Core Specification 5.1'),
    0x0B: BtVersion(5, 2, 'Bluetooth Core Specification 5.2'),
