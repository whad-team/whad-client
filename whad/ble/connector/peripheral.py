...
class Peripheral(BLE):
    ...
    def __init__(self, device, existing_connection = None, profile=None, adv_data=None, scan_data=None, bd_address=None, public=False, stack=BleStack, pairing=Pairing(), security_database=None):
