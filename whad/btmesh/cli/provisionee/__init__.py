...
from whad.btmesh.cli.provisionee.shell import BTMeshProvisioneeShell

from .commands import *


class BTMeshProvisioneeApp(CommandLineApp):
    ...
    def __init__(self):
        ...
        """
        super().__init__(
            description="WHAD Bluetooth Mesh provisionee utility",
            commands=True,
            interface=True,
        )
    ...
    def run(self):
        ...
        if self.args.script is not None:
            ...
            myshell = BTMeshProvisioneeShell(self.interface)
...
def btmesh_provisionee_main():
    """BTMesh provisionee emulation main routine.
    """
    app = BTMeshProvisioneeApp()
    run_app(app)
