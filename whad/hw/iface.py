...
class IfaceEvt:
    ...
    def __repr__(self) -> str:
        ...
        """
        return f"IfaceEvt(iface='{self.iface.interface}')"
...
class Disconnected(IfaceEvt):
    ...
    def __repr__(self) -> str:
        """Printable representation of this event.
        """
        return f"DisconnectedEvt(iface='{self.iface.interface}')"
...
class MessageReceived(IfaceEvt):
    ...
    def __repr__(self) -> str:
        """Printable representation of this event.
        """
        return f"MessageReceived(iface='{self.iface.interface}')"
...
class Interface:
    ...
    def _get_sub_classes(cls):
        ...
        for device_class in cls.__subclasses__():
            if device_class.__name__ in ("VirtualInterface", "VirtualDevice"):
    ...
    def put_message(self, message: Union[HubMessage, IfaceEvt]):
        ...
        elif isinstance(message, IfaceEvt):
