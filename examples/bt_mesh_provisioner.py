...
link_open = BTMesh_Generic_Provisioning_Link_Open(bearer_opcode=0, generic_provisioning_control_format=3,device_uuid='7462d668-bc88-3473-0000-000000000000')

pkt = EIR_Hdr(type=0x29) / EIR_PB_ADV_PDU(link_id=b'abcd', transaction_number=0, data = link_open)
